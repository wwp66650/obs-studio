...
#define CHROMA_CONV_FULL(val, new_val, ret) \
	...
	CHROMA_CONV("yv12", "NV12", VIDEO_FORMAT_NV12);
	CHROMA_CONV("I09B", "NV12", VIDEO_FORMAT_NV12);
	CHROMA_CONV("I09L", "NV12", VIDEO_FORMAT_NV12);
	CHROMA_CONV("I0AB", "NV12", VIDEO_FORMAT_NV12);
	CHROMA_CONV("I0AL", "NV12", VIDEO_FORMAT_NV12);
	CHROMA_CONV("I40A", "RGBA", VIDEO_FORMAT_RGBA);
	...
	CHROMA_CONV("I42A", "RGBA", VIDEO_FORMAT_RGBA);

	CHROMA_CONV("I29L", "RGBA", VIDEO_FORMAT_RGBA);
	CHROMA_CONV("I29B", "RGBA", VIDEO_FORMAT_RGBA);
	CHROMA_CONV("I2AL", "RGBA", VIDEO_FORMAT_RGBA);
	CHROMA_CONV("I2AB", "RGBA", VIDEO_FORMAT_RGBA);
